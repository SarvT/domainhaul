export default function About() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-4">About DomainScan</h1>
      <p className="mb-4">
        DomainScan is a powerful tool designed to provide comprehensive domain analysis. Our platform offers insights
        into DNS records, WHOIS information, SSL certificates, and more, helping users understand the technical aspects
        of any domain.
      </p>
      <p className="mb-4">
        Whether you're a developer, security researcher, or simply curious about how websites work, DomainScan provides
